  ...
  const dockedPlayer = audioUrl && (
    <div className="border-t border-border bg-surface/60 px-3.5 pb-1.5 pt-2.5">
      ...
      <div className="relative flex items-center justify-between pb-2.5">
        ...
        <button type="button" onClick={togglePlay} aria-label={playing ? "توقف" : "پخش"} className="absolute left-1/2 top-0 inline-flex size-11 -translate-x-1/2 items-center justify-center rounded-full bg-primary text-primary-foreground transition-opacity hover:opacity-90">
      ...
      </div>ateFileRoute } from "@tanstack/react-router";
import { useCallback, useEffect, useLayoutEffect, useMemo, useRef, useState } from "react";
import {
  Mic,
  Square,
